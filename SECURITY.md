...
and credit the reporter (if desired). If the report is declined, we will share
a brief rationale (for example, out-of-scope behavior or insufficient evidence).

Please do not disclose vulnerabilities publicly until we have investigated and
released a mitigation or fix.
