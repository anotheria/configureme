 ...
 * @author Ivan Batura
 */
public class MethodAnnotationProcessorSetAll implements MethodAnnotationProcessor {
    private static final Logger LOGGER = LoggerFactory.getLogger(MethodAnnotationProcessorSetAll.class);
